...
const categories = [
  ...
  { name: 'Lake Minnetonka', items: ['Big Island','Maynard\'s','Pontoon','Al and Almas','Mansion','Excelsior','Lord Fletchers','Volleyball','Yacht','Howard\'s Point','Swimming','Skiing','Tubing','Sunsets','Prince','Cargill Mansion'] },
